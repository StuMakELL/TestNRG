...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef *hdac)
{
    if (hdac->Instance == DAC1)
    {
        ...
        PA5     ------> DAC1_OUT2
        */
        HAL_GPIO_DeInit(DAC1_OUT2_GPIO_Port, DAC1_OUT2_Pin);
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef *heth)
{
    if (heth->Instance == ETH)
    {
        ...
        PC4     ------> ETH_RXD0
        */
        HAL_GPIO_DeInit(GPIOC, RMII_MDC_Pin | RMII_RXD1_Pin | RMII_RXD0_Pin);

        HAL_GPIO_DeInit(GPIOB, RMII_TXD1_Pin | RMII_TXD0_Pin | RMII_RX_ER_Pin | RMII_TX_EN_Pin);

        HAL_GPIO_DeInit(GPIOA, RMII_CRS_DV_Pin | RMII_REF_CLK_Pin | RMII_MDIO_Pin);
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef *hfdcan)
{
    if (hfdcan->Instance == FDCAN1)
    {
        ...
        PH13     ------> FDCAN1_TX
        */
        HAL_GPIO_DeInit(GPIOH, FDCAN1_RX_Pin | FDCAN1_TX_Pin);
    ...
    else if (hfdcan->Instance == FDCAN2)
    {
        ...
        PB5     ------> FDCAN2_RX
        */
        HAL_GPIO_DeInit(GPIOB, FDCAN2_TX_Pin | FDCAN2_RX_Pin);
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
    ...
    if (hltdc->Instance == LTDC)
    {
        ...
        */
        ...
        GPIO_InitStruct.Pin = LCD_R0_Pin | LCD_R6_Pin | LCD_B4_Pin | LCD_DE_Pin | LCD_R7_Pin | LCD_G3_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
        ...
        GPIO_InitStruct.Pin = LCD_G4_Pin | LCD_R5_Pin | LCD_R3_Pin | LCD_R2_Pin | LCD_R4_Pin | LCD_R1_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef *hltdc)
{
    if (hltdc->Instance == LTDC)
    {
        ...
        */
        ...
        HAL_GPIO_DeInit(GPIOE, LCD_R0_Pin | LCD_R6_Pin | LCD_B4_Pin | LCD_DE_Pin | LCD_R7_Pin | LCD_G3_Pin);

        HAL_GPIO_DeInit(GPIOA, LCD_B3_Pin | LCD_B5_Pin | LCD_VSYNC_Pin | LCD_G2_Pin);

        HAL_GPIO_DeInit(GPIOG, LCD_B0_Pin | LCD_CLK_Pin);

        HAL_GPIO_DeInit(GPIOH, LCD_G4_Pin | LCD_R5_Pin | LCD_R3_Pin | LCD_R2_Pin | LCD_R4_Pin | LCD_G5_Pin | LCD_R1_Pin);
...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef *hospi)
{
    ...
    else if (hospi->Instance == OCTOSPI2)
    {
        ...
        */
        ...
        GPIO_InitStruct.Pin = OCSPI2_IO1_Pin | OCSPI2_IO0_Pin | OCSPI2_IO2_Pin | OCSPI2_CLK_Pin | OCSPI2_IO3_Pin | OCSPI2_DQS_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        GPIO_InitStruct.Alternate = GPIO_AF9_OCTOSPIM_P2;
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef *hospi)
{
    if (hospi->Instance == OCTOSPI1)
    {
        ...
        */
        ...
        HAL_GPIO_DeInit(GPIOD, OCSPI1_IO7_Pin | OCSPI1_IO5_Pin | OCSPI1_IO4_Pin | OCSPI1_IO3_Pin | OCSPI1_IO0_Pin | OCSPI1_IO1_Pin);

        HAL_GPIO_DeInit(OCSPI1_IO2_GPIO_Port, OCSPI1_IO2_Pin);

        HAL_GPIO_DeInit(OCSPI1_CLK_GPIO_Port, OCSPI1_CLK_Pin);

        HAL_GPIO_DeInit(OCSPI1_DQS_GPIO_Port, OCSPI1_DQS_Pin);
    ...
    else if (hospi->Instance == OCTOSPI2)
    {
        ...
        PF12     ------> OCTOSPIM_P2_DQS
        */
        HAL_GPIO_DeInit(GPIOG, OCSPI2_IO7_Pin | OCSPI2_IO6_Pin | OCSPI2_NCS_Pin | OCSPI2_IO5_Pin | OCSPI2_IO4_Pin);

        HAL_GPIO_DeInit(GPIOF, OCSPI2_IO1_Pin | OCSPI2_IO0_Pin | OCSPI2_IO2_Pin | OCSPI2_CLK_Pin | OCSPI2_IO3_Pin | OCSPI2_DQS_Pin);
...
void HAL_SD_MspInit(SD_HandleTypeDef *hsd)
{
    ...
    if (hsd->Instance == SDMMC1)
    {
        ...
        */
        ...
        GPIO_InitStruct.Pin = SDIO1_CK_Pin | SDIO1_D3_Pin | SDIO1_D2_Pin | SDIO1_D0_Pin | SDIO1_D1_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        GPIO_InitStruct.Alternate = GPIO_AF12_SDMMC1;
...
void HAL_SD_MspDeInit(SD_HandleTypeDef *hsd)
{
    if (hsd->Instance == SDMMC1)
    {
        ...
        */
        ...
        HAL_GPIO_DeInit(GPIOC, SDIO1_CK_Pin | SDIO1_D3_Pin | SDIO1_D2_Pin | SDIO1_D0_Pin | SDIO1_D1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart)
{
    if (huart->Instance == USART1)
    {
        ...
        PB14     ------> USART1_TX
        */
        HAL_GPIO_DeInit(GPIOB, ARD_D0_Pin | ARD_D1_Pin);
    ...
    else if (huart->Instance == USART3)
    {
        ...
        PD8     ------> USART3_TX
        */
        HAL_GPIO_DeInit(GPIOD, T_VCP_RX_Pin | T_VCP_TX_Pin);
...
void HAL_SAI_MspDeInit(SAI_HandleTypeDef *hsai)
{
    ...
    if (hsai->Instance == SAI1_Block_B)
    {
        ...
        PF9     ------> SAI1_FS_B
        */
        HAL_GPIO_DeInit(GPIOF, SAI1_SD_B_Pin | SAI1_SCK_B_Pin | SAI1_MCLK_B_Pin | SAI1_FS_B_Pin);
    }
}
